...
object Constants {
    ...
    const val PARKINGBUDDY = "https://play.google.com/store/apps/details?id=com.yondu.parkingbuddy"
    const val UNIONBANK = "https://play.google.com/store/apps/details?id=com.unionbankph.online"

    const val SECTION_WIDTH = 1920
    const val FONT_FAMILY = "Roboto"

    const val ANDROID_SERVICE =
        "Bringing seven years of hands-on experience in crafting scalable mobile applications. Proficient with Android development tools including Android Studio, Gradle, and the Android SDK. Familiar with MVVM and CLEAN Architecture using Kotlin/Java."
    const val IOS_SERVICE =
        "Although my experience in iOS development is not extensive, I have effectively maintained iOS apps and released them on the App Store. Currently, I am getting familiar with well-known iOS development frameworks like UIKit and SwiftUI."
    const val WEB_SERVICE =
        "Continuously fascinated by coding and crafting digital solutions, I've begun familiarizing myself with renowned web development frameworks like Kobweb, and this static website is a product of that exploration."
    const val CROSS_PLATFORM_SERVICE =
        "Dedicated to cross-platform development, leveraging the Flutter framework on both Android and iOS devices. Successfully contributed to casual games projects on Unity, managing assets, and coding for Play Store and App Store releases."
    const val UI_UX_SERVICE =
        "Proficient in utilizing design tools such as Sketch, Figma, Adobe XD. Additionally, I possess the ability to translate UI designs seamlessly into code, ensuring a smooth transition from concept to implementation."
    const val EDITING_SERVICE =
        "Bringing more than a decade of experience in video editing, including proficiency in visual effects and compositing using tools like Adobe After Effects."
...
object Res {
    object Image {
        ...
        const val solodaily = "solodaily.png"
        ...
        const val portfolio7 = "portfolio7.png"
        const val portfolio8 = "portfolio8.png"
        const val portfolio9 = "portfolio9.jpg"
        const val portfolio10 = "portfolio10.jpg"
        const val portfolio11 = "portfolio11.jpg"
        const val portfolio12 = "portfolio12.jpg"
        const val portfolio13 = "portfolio13.jpg"
        const val portfolio14 = "portfolio14.png"
        const val parkingbuddy = "parkingbuddy.jpg"
        ...
        const val WORK_6 = "images/work_bcs_logo.jpg"
    }
    ...
    object Icon {
        ...
        const val flutter = "cross_platform.svg"
